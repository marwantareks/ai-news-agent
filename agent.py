...
def generate_html(summary: dict, date_str: str) -> str:
    ...
    invite_html = (
        f'<span>Know someone who\'d enjoy this? <a href="{signup_page_url}" style="color:#aaa;">Invite them to subscribe</a> &nbsp;&middot;&nbsp; </span>'
        if signup_page_url else ""
    )
...
<body>
  <div class="wrapper">
    ...
    <div style="text-align:center; padding: 1.5rem 1rem; font-size:.78rem; color:#aaa;">
      {invite_html}Don't want these? <a href="{resend_unsub_url}" style="color:#aaa;">Unsubscribe</a>
    </div>
