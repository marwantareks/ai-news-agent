...
def _send_confirmation_email(email, ts, sig, confirm_base_url, headers):
    ...
    html_body = (
        ...
        f'<a href="{confirm_url}" style="background:linear-gradient(135deg,#667eea,#764ba2);'
        'color:#fff;padding:.8rem 1.5rem;border-radius:8px;text-decoration:none;'
        'font-weight:600;display:inline-block;">Confirm my subscription</a>'
        '</p>'
        '<p style="color:#aaa;font-size:.85rem;">This link expires in 24 hours. '
